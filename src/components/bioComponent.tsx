	...
	return (
		<main className="max-w-5xl mx-auto px-6 mt-12">
			<div className="flex flex-col md:flex-row md:items-start items-center gap-6">
				...
				<div className="w-[180px] h-[180px] flex-shrink-0 overflow-hidden rounded-lg relative mx-auto md:mx-0 ring-4 ring-white/30 shadow-[0_0_10px_rgba(255,255,255,0.55)] transition-shadow duration-200 hover:shadow-[0_0_20px_rgba(255,255,255,0.9)] transform hover:scale-[1.02]">
					<Image
						src="/profile.png"
						alt="Toni Correia"
						fill
